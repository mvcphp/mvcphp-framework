...
class Route {
    ...
    public static function start() {
        ...
        $routing_parameters = Mapper::get_parameters($routing_map['admin'], $routes, $controller_name, $action_name, $action_parameters);
        ...
        $model_path = Q_PATH . '/admin/application/models/' . $model_file;
        if (file_exists($model_path)) {
            foreach (Booter::boot(array('/admin/application/models/' . $model_file)) as $inc_file) {
                include $inc_file;
            }
        }
        else {
        ...
        $controller_path = Q_PATH . '/admin/application/controllers/' . $controller_file;
        if (file_exists($controller_path)) {
            foreach (Booter::boot(array('/admin/application/controllers/' . $controller_file)) as $inc_file) {
                include $inc_file;
            }
        } 
        else {
    ...
    public static function NoFound() {
        ...
        header('Location:' . $host . 'admin/404/');
        exit();
    }
