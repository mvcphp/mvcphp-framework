...
//spl_autoload_register(array('Booter','admin_autoload'));


foreach (Booter::boot(array(
    '/admin/application/core/model.php',
    '/admin/application/core/view.php',
    '/admin/application/core/controller.php',
...
foreach (Booter::boot(array(
    '/admin/application/core/route.php'
)) as $inc_file) {
    include $inc_file;
}
